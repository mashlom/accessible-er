...
export const themes: QuestTheme[] = [
  {
    ...
    procedureNarratives: {
      'temperature':       'הקוסם בודק את האש הפנימית של הגיבור/ת — כמה חום קסמים נושא הגוף בתוכו.',
  ...
  },
  {
    ...
    procedureNarratives: {
      ...
      'blood-pressure':  'המדריך בודק את עוצמת זרם החיים בזרוע — כדי לדעת כמה כוח יש לגיבור/ת המסע.',
  ...
  },
  {
    ...
    procedureNarratives: {
      'temperature':     'פיית הריפוי בודקת את אש הפנים של הגיבור/ת — כדי לדעת איזה קסם יעזור.',
      'saturation':      'טבעת הקסם הוורודה על האצבע בודקת שקסם האוויר זורם בדם כמו שצריך.',
      'blood-pressure':  'שרוול הפיות לוחץ קלות ובודק את עוצמת הלב הקסום של הגיבור/ת.',
      'doctor-exam':     'פיית הריפוי בוחנת בעדינות את כוחות הגיבור/ת — ממנה יבוא הקסם המתאים.',
      ...
      'iv':              'הצינור הדק של הפיה שולח קסם ריפוי ישירות לדם של הגיבור/ת.',
      'medication':      'פיית הריפוי הכינה קסם מיוחד — סירופ או תרכובת שתחזק את הגיבור/ת.',
  ...
  },
  {
    ...
    procedureNarratives: {
      ...
      'saturation':      'חיישן החמצן הקטן בודק שדם הגיבור/ת נושא מספיק אוויר לאורך כל המסע.',
      'blood-pressure':  'המדריך מודד את עוצמת הלב — כדי לוודא שהגיבור/ת מוכן/ה לתנאי השדה.',
      ...
      'urine':           'כוסית הדגימה תגלה לרופא השבט מה מתרחש בגוף הגיבור/ת.',
