...
export const journeyStages: JourneyStage[] = [
  {
    ...
    whatHappens: 'המזכיר/ה שואל/ת פרטים ופותח/ת תיק ביקור. מקבלים לרוב צמיד זיהוי. יכול להיות עומדים קרוב לאנשים אחרים בתור.',
  ...
  },
  {
    ...
    whatHappens: 'אחות מודדת חום, דופק, לחץ דם וחמצן, ושואלת שאלות קצרות. שמים צמיד זיהוי אם עוד לא. האחות נוגעת ביד, באצבע או בזרוע במהלך המדידות, ומשתמשים במכשירים כמו מד חום, קליפס לאצבע (לחמצן) ושרוול לחץ דם.',
  ...
  },
  {
    ...
    whatHappens: 'ממתינים בחדר ההמתנה או בעמדה. אפשר להשתמש בזמן הזה להכנה לצעד הבא. החדר עלול להיות צפוף, עם אנשים יושבים קרוב.',
  ...
  },
  {
    ...
    whatHappens: 'שיחה קצרה, בדיקה גופנית, והחלטה על בדיקות או טיפול לפי הצורך. כולל מגע גופני קל ומגע עם מכשירים — סטטוסקופ על החזה, מכשיר קטן לבדיקת גרון ואוזניים, ולפעמים לחיצה עדינה על הבטן.',
  ...
  },
  {
    ...
    whatHappens: 'מבצעים את הבדיקות שהוחלטו — דם, שתן, צילום, אולטרסאונד או אחרות. אפשר להכין את הילד/ה מראש לכל אחת. חלק מהבדיקות כוללות מגע עם מכשירים או חומרים (כמו ג׳ל אולטרסאונד, חגורת רנטגן או משחה מאלחשת).',
  ...
  },
  {
    ...
    whatHappens:
      'רופא/ה נוסף/ת מגיע/ה, שואל/ת ובודק/ת, ולפעמים ממליץ/ה על בדיקה נוספת או טיפול. יכול לכלול עוד בדיקה גופנית קצרה.',
  ...
  },
  {
    ...
    whatHappens: 'מבצעים את הטיפול שהוחלט — עירוי, תרופות, אינהלציה, גבס, חבישה או תפירה. לרוב אפשר לבקש התאמות שמקלות. כל הטיפולים האלה כוללים מגע גופני ולפעמים עם מכשירים — כמו מחט לעירוי, או גבס שמונח על הגוף.',
